...
class TestConcreteMessageService(unittest.TestCase):
    @patch('foundations.config_reader.config_reader.ConfigReader', return_value={
    ...
    def test_delete_message(self, mock_db_client, mock_query_builder):
        ...
        self.message_service.delete_message("user_id", "message_id")  # No assertion needed if not expecting a result
